...
plot(interval_grouped$interval, interval_grouped$avg, type="l", xlab="Interval", ylab="Average steps")
```
...
date_grouped1 <- aggregate(list(total_steps=df$steps), list(date=df$date), sum)

barplot(date_grouped$total_steps, names.arg=c(), xlab="day", ylab="steps", main="Total steps")
```
